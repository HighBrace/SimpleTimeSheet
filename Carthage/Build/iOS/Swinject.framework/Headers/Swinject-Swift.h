...
- (UIViewController * __nonnull)instantiateViewControllerWithIdentifier:(NSString * __nonnull)identifier;
@end
...
@property (nonatomic, copy) NSString * __nullable swinjectRegistrationName;
@end
